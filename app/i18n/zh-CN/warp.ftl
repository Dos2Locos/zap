...
workspace-left-panel-ssh-manager-sftp-col-name = 名称
workspace-left-panel-ssh-manager-sftp-col-size = 大小
workspace-left-panel-ssh-manager-sftp-col-modified = 修改时间
# SFTP 文件管理器
sftp-browser-file-manager = 文件管理
sftp-browser-create-channel-failed = 创建 SFTP 通道失败: { $error }
sftp-browser-connection-cancelled = 连接已取消
sftp-browser-server-config-not-found = 未找到服务器配置
sftp-browser-not-connected = 未连接到服务器
sftp-browser-list-dir-failed = 列出目录失败: { $error }
sftp-browser-delete-failed = 删除失败: { $error }
sftp-browser-filename-invalid-chars = 文件名包含非法字符
sftp-browser-upload-failed = 上传失败: { $error }
sftp-browser-upload-failed-not-connected = 上传失败: 未连接到服务器
sftp-browser-download-failed = 下载失败: { $error }
sftp-browser-download-failed-not-connected = 下载失败: 未连接到服务器
sftp-browser-name-empty = 名称不能为空
sftp-browser-name-invalid-separator = 名称不合法：不能包含路径分隔符
sftp-browser-rename-failed = 重命名失败: { $error }
sftp-browser-folder-name-empty = 文件夹名称不能为空
sftp-browser-create-folder-failed = 创建文件夹失败: { $error }
sftp-browser-target-path-invalid = 目标路径不合法
sftp-browser-move-failed = 移动失败: { $error }
sftp-browser-drop-files-to-upload = 拖放文件以上传
sftp-menu-open = 打开
sftp-menu-download = 下载
sftp-menu-rename = 重命名
sftp-menu-delete = 删除
sftp-menu-details = 详细信息
sftp-dialog-cancel = 取消
sftp-dialog-delete-confirm-single = 确定要删除 "{ $name }" 吗？此操作不可撤销。
sftp-dialog-delete-confirm-multiple = 确定要删除 { $count } 个项目吗？此操作不可撤销。
sftp-dialog-delete-title = 确认删除
sftp-dialog-delete-button = 删除
sftp-dialog-rename-title = 重命名
sftp-dialog-rename-current-name = 当前名称: { $name }
sftp-dialog-confirm-button = 确定
sftp-dialog-create-folder-title = 新建文件夹
sftp-dialog-create-button = 创建
sftp-dialog-file-details-title = 文件详情
sftp-dialog-file-type-file = 文件
sftp-dialog-file-type-directory = 目录
sftp-dialog-file-type-symlink = 符号链接
sftp-dialog-file-type-other = 其他
sftp-dialog-field-type = 类型
sftp-dialog-field-size = 大小
sftp-dialog-field-modified = 修改时间
sftp-dialog-field-permissions = 权限
sftp-dialog-field-path = 路径
sftp-dialog-move-description = 将 "{ $name }" 移动到 { $target }
sftp-dialog-move-title = 移动文件
sftp-dialog-move-button = 移动
sftp-dialog-overwrite-remote = 远程文件 { $name } 已存在，是否覆盖？
sftp-dialog-overwrite-local = 目标文件 { $name } 已存在，是否覆盖？
sftp-dialog-overwrite-title = 确认覆盖
sftp-dialog-overwrite-button = 覆盖
sftp-dialog-close-transfer-panel-title = 关闭传输面板
sftp-dialog-close-transfer-panel-description = 有正在进行的传输任务，关闭将中断所有传输并清空记录。确定要关闭吗？
sftp-dialog-close-button = 关闭
sftp-transfer-state-pending = 等待中
sftp-transfer-state-in-progress = 传输中
sftp-transfer-state-completed = 已完成
sftp-transfer-state-failed = 失败
sftp-transfer-state-cancelled = 已取消
sftp-transfer-panel-title = 传输 ({ $count })
sftp-ops-resolve-auth-failed = 解析认证失败: { $error }
sftp-ops-rename-remote-temp-failed = 重命名远程临时文件失败: { $error }。临时文件: { $temp }
sftp-ops-rename-local-temp-failed = 重命名失败: { $error }。已下载的临时文件保留在: { $temp }
sftp-ops-read-password-failed = 读取密码失败: { $error }
sftp-ops-key-auth-no-key-path = 密钥认证但未指定密钥路径
sftp-backend-list-dir-failed = 列出目录失败 { $path }: { $error }
sftp-backend-read-dir-entry-failed = 读取目录条目失败: { $error }
sftp-backend-read-metadata-failed = 读取元数据失败: { $error }
sftp-backend-delete-file-failed = 删除文件失败 { $path }: { $error }
sftp-backend-recursive-delete-dir-failed = 递归删除目录失败 { $path }: { $error }
sftp-backend-create-dir-failed = 创建目录失败 { $path }: { $error }
sftp-backend-rename-failed = 重命名失败 { $old_path } -> { $new_path }: { $error }
sftp-backend-resolve-path-failed = 解析路径失败 { $path }: { $error }
sftp-backend-stat-file-failed = 获取文件信息失败 { $path }: { $error }
sftp-backend-create-dir-io-failed = 创建目录失败: { $error }
sftp-backend-upload-file-failed = 上传文件失败: { $error }
sftp-backend-open-remote-file-failed = 打开远程文件失败: { $error }
sftp-backend-create-local-file-failed = 创建本地文件失败: { $error }
sftp-backend-read-failed = 读取失败: { $error }
sftp-backend-write-failed = 写入失败: { $error }
sftp-backend-flush-failed = 刷新失败: { $error }
sftp-ops-err-connection = 连接错误: { $msg }
sftp-ops-err-operation = 操作错误: { $msg }
sftp-ops-err-local-io = 本地 IO 错误: { $msg }
sftp-ops-err-no-credentials = 未找到凭据: { $msg }
sftp-ops-err-cancelled = 传输已取消
...
workspace-left-panel-ssh-manager-candidates-sync = 将已导入主机与 ~/.ssh/config 同步
workspace-left-panel-ssh-manager-sync-title = 与 ~/.ssh/config 同步
workspace-left-panel-ssh-manager-sync-up-to-date = 所有已导入主机均为最新。
workspace-left-panel-ssh-manager-sync-drift = 别名已不在 ~/.ssh/config 中
workspace-left-panel-ssh-manager-sync-error = 无法读取 ~/.ssh/config:{ $error }
workspace-left-panel-ssh-manager-sync-field-port = 端口
workspace-left-panel-ssh-manager-sync-field-user = 用户
workspace-left-panel-ssh-manager-sync-field-identity = 身份密钥
workspace-left-panel-ssh-manager-sync-apply = 应用
workspace-left-panel-ssh-manager-sync-cancel = 取消
workspace-left-panel-ssh-manager-sync-close = 关闭
workspace-left-panel-ssh-manager-import-all = 全部导入…
workspace-left-panel-ssh-manager-import-all-title = 从 ~/.ssh/config 导入
workspace-left-panel-ssh-manager-import-all-empty = 没有可导入的主机。
workspace-left-panel-ssh-manager-import-all-confirm = 导入
workspace-left-panel-ssh-manager-import-all-cancel = 取消
workspace-left-panel-ssh-manager-tab-general = 常规
workspace-left-panel-ssh-manager-tab-forwarding = 端口转发
workspace-left-panel-ssh-manager-forward-kind-local = 本地
workspace-left-panel-ssh-manager-forward-kind-remote = 远程
workspace-left-panel-ssh-manager-forward-kind-dynamic = 动态
workspace-left-panel-ssh-manager-forward-bind-host = 绑定主机
workspace-left-panel-ssh-manager-forward-bind-port = 绑定端口
workspace-left-panel-ssh-manager-forward-target-host = 目标主机
workspace-left-panel-ssh-manager-forward-target-port = 目标端口
workspace-left-panel-ssh-manager-forward-description = 描述(可选)
workspace-left-panel-ssh-manager-forward-add = 添加转发
workspace-left-panel-ssh-manager-forward-empty = 暂无端口转发。
workspace-left-panel-ssh-manager-forward-delete = 删除
workspace-left-panel-ssh-manager-forward-invalid = 请输入有效的绑定主机和端口;本地/远程转发还需填写目标主机和端口。
