...
settings-about-automatic-updates-description = When enabled, Zap checks for new versions in the background and downloads the installer to a local cache. The currently running Zap is not touched until you click "Install now" to launch the installer yourself.
...
settings-about-update-install-hint-macos = The installer will open — drag Zap into your Applications folder to finish.
settings-about-update-install-hint-windows = The setup wizard will launch — follow the prompts to finish the upgrade.
settings-about-update-install-hint-linux = The AppImage will be replaced in place and Zap will restart.
...
workspace-left-panel-ssh-manager-sftp-col-name = Name
workspace-left-panel-ssh-manager-sftp-col-size = Size
workspace-left-panel-ssh-manager-sftp-col-modified = Modified
# SFTP file manager
sftp-browser-file-manager = File Manager
sftp-browser-create-channel-failed = Failed to create SFTP channel: { $error }
sftp-browser-connection-cancelled = Connection cancelled
sftp-browser-server-config-not-found = Server configuration not found
sftp-browser-not-connected = Not connected to server
sftp-browser-list-dir-failed = Failed to list directory: { $error }
sftp-browser-delete-failed = Delete failed: { $error }
sftp-browser-filename-invalid-chars = Filename contains invalid characters
sftp-browser-upload-failed = Upload failed: { $error }
sftp-browser-upload-failed-not-connected = Upload failed: not connected to server
sftp-browser-download-failed = Download failed: { $error }
sftp-browser-download-failed-not-connected = Download failed: not connected to server
sftp-browser-name-empty = Name cannot be empty
sftp-browser-name-invalid-separator = Invalid name: cannot contain path separators
sftp-browser-rename-failed = Rename failed: { $error }
sftp-browser-folder-name-empty = Folder name cannot be empty
sftp-browser-create-folder-failed = Failed to create folder: { $error }
sftp-browser-target-path-invalid = Invalid target path
sftp-browser-move-failed = Move failed: { $error }
sftp-browser-drop-files-to-upload = Drop files to upload
sftp-menu-open = Open
sftp-menu-download = Download
sftp-menu-rename = Rename
sftp-menu-delete = Delete
sftp-menu-details = Details
sftp-dialog-cancel = Cancel
sftp-dialog-delete-confirm-single = Are you sure you want to delete "{ $name }"? This action cannot be undone.
sftp-dialog-delete-confirm-multiple = Are you sure you want to delete { $count } items? This action cannot be undone.
sftp-dialog-delete-title = Confirm Deletion
sftp-dialog-delete-button = Delete
sftp-dialog-rename-title = Rename
sftp-dialog-rename-current-name = Current name: { $name }
sftp-dialog-confirm-button = OK
sftp-dialog-create-folder-title = New Folder
sftp-dialog-create-button = Create
sftp-dialog-file-details-title = File Details
sftp-dialog-file-type-file = File
sftp-dialog-file-type-directory = Directory
sftp-dialog-file-type-symlink = Symbolic Link
sftp-dialog-file-type-other = Other
sftp-dialog-field-type = Type
sftp-dialog-field-size = Size
sftp-dialog-field-modified = Modified
sftp-dialog-field-permissions = Permissions
sftp-dialog-field-path = Path
sftp-dialog-move-description = Move "{ $name }" to { $target }
sftp-dialog-move-title = Move File
sftp-dialog-move-button = Move
sftp-dialog-overwrite-remote = The remote file { $name } already exists. Overwrite it?
sftp-dialog-overwrite-local = The destination file { $name } already exists. Overwrite it?
sftp-dialog-overwrite-title = Confirm Overwrite
sftp-dialog-overwrite-button = Overwrite
sftp-dialog-close-transfer-panel-title = Close Transfer Panel
sftp-dialog-close-transfer-panel-description = There are transfers in progress. Closing will interrupt all transfers and clear the records. Are you sure you want to close?
sftp-dialog-close-button = Close
sftp-transfer-state-pending = Pending
sftp-transfer-state-in-progress = Transferring
sftp-transfer-state-completed = Completed
sftp-transfer-state-failed = Failed
sftp-transfer-state-cancelled = Cancelled
sftp-transfer-panel-title = Transfers ({ $count })
sftp-ops-resolve-auth-failed = Failed to resolve authentication: { $error }
sftp-ops-rename-remote-temp-failed = Failed to rename remote temporary file: { $error }. Temporary file: { $temp }
sftp-ops-rename-local-temp-failed = Rename failed: { $error }. The downloaded temporary file is kept at: { $temp }
sftp-ops-read-password-failed = Failed to read password: { $error }
sftp-ops-key-auth-no-key-path = Key authentication selected but no key path specified
sftp-backend-list-dir-failed = Failed to list directory { $path }: { $error }
sftp-backend-read-dir-entry-failed = Failed to read directory entry: { $error }
sftp-backend-read-metadata-failed = Failed to read metadata: { $error }
sftp-backend-delete-file-failed = Failed to delete file { $path }: { $error }
sftp-backend-recursive-delete-dir-failed = Failed to recursively delete directory { $path }: { $error }
sftp-backend-create-dir-failed = Failed to create directory { $path }: { $error }
sftp-backend-rename-failed = Failed to rename { $old_path } -> { $new_path }: { $error }
sftp-backend-resolve-path-failed = Failed to resolve path { $path }: { $error }
sftp-backend-stat-file-failed = Failed to get file info { $path }: { $error }
sftp-backend-create-dir-io-failed = Failed to create directory: { $error }
sftp-backend-upload-file-failed = Failed to upload file: { $error }
sftp-backend-open-remote-file-failed = Failed to open remote file: { $error }
sftp-backend-create-local-file-failed = Failed to create local file: { $error }
sftp-backend-read-failed = Read failed: { $error }
sftp-backend-write-failed = Write failed: { $error }
sftp-backend-flush-failed = Flush failed: { $error }
sftp-ops-err-connection = Connection error: { $msg }
sftp-ops-err-operation = Operation error: { $msg }
sftp-ops-err-local-io = Local I/O error: { $msg }
sftp-ops-err-no-credentials = Credentials not found: { $msg }
sftp-ops-err-cancelled = Transfer cancelled
...
workspace-left-panel-ssh-manager-candidates-sync = Sync imported hosts with ~/.ssh/config
workspace-left-panel-ssh-manager-sync-title = Sync with ~/.ssh/config
workspace-left-panel-ssh-manager-sync-up-to-date = All imported hosts are up to date.
workspace-left-panel-ssh-manager-sync-drift = Alias no longer in ~/.ssh/config
workspace-left-panel-ssh-manager-sync-error = Could not read ~/.ssh/config: { $error }
workspace-left-panel-ssh-manager-sync-field-port = Port
workspace-left-panel-ssh-manager-sync-field-user = User
workspace-left-panel-ssh-manager-sync-field-identity = Identity
workspace-left-panel-ssh-manager-sync-apply = Apply
workspace-left-panel-ssh-manager-sync-cancel = Cancel
workspace-left-panel-ssh-manager-sync-close = Close
workspace-left-panel-ssh-manager-import-all = Import all…
workspace-left-panel-ssh-manager-import-all-title = Import from ~/.ssh/config
workspace-left-panel-ssh-manager-import-all-empty = No importable hosts.
workspace-left-panel-ssh-manager-import-all-confirm = Import
workspace-left-panel-ssh-manager-import-all-cancel = Cancel
workspace-left-panel-ssh-manager-tab-general = General
workspace-left-panel-ssh-manager-tab-forwarding = Port forwarding
workspace-left-panel-ssh-manager-forward-kind-local = Local
workspace-left-panel-ssh-manager-forward-kind-remote = Remote
workspace-left-panel-ssh-manager-forward-kind-dynamic = Dynamic
workspace-left-panel-ssh-manager-forward-bind-host = Bind host
workspace-left-panel-ssh-manager-forward-bind-port = Bind port
workspace-left-panel-ssh-manager-forward-target-host = Target host
workspace-left-panel-ssh-manager-forward-target-port = Target port
workspace-left-panel-ssh-manager-forward-description = Description (optional)
workspace-left-panel-ssh-manager-forward-add = Add forward
workspace-left-panel-ssh-manager-forward-empty = No port forwards yet.
workspace-left-panel-ssh-manager-forward-delete = Delete
workspace-left-panel-ssh-manager-forward-invalid = Enter a valid bind host and port, plus target host and port for Local/Remote forwards.
